...
<div class="page-head">
  ...
  <p class="lede">How Throughline runs week to week, how decisions get made, and how the operating record stays current.</p>
</div>
...
{{ site.data.company.decision_rule }}

- **In-domain calls** belong to the lead who owns that domain — they decide and log.
- **Cross-domain calls** need any **2 of 4** leads aligned.
- **Deadlocks** are broken by the Managing Partner; the dissenting view is recorded on the decision, not erased. We disagree and commit.
- **Escalation-class** decisions — anything legal, financial, ownership, or ethical — go to the Chairman. Nothing else does.
...
Assumptions are documented wherever evidence is incomplete. We would rather show the Chairman a clearly-labeled hypothesis than a false certainty.
...
Humans own taste, client trust, judgment calls, and the final 20% of craft that clients actually pay for.
